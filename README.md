...
> Read the MITRE Mapping - A technical deep-dive into how Sentinel aligns with the ATT&CK framework.
> 
 ...
 * Trigger: User opens top_secret.pdf.
 * Analysis: Brain tags file as SENSITIVE_USER_FILE.
 * Action: Brain writes the filename to signatures.txt.
 * Enforcement: Hyperion XDP (Network Firewall) reads the signature and instantly drops any outgoing packet containing that filename.
 ...
 * Features:
   ...
   * Optimization: Code path optimized to <5µs latency.
